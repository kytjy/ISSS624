...
Interpretation: - There are 88 area units in Hunan. - Most connect area unit has 10 neighbours. - There are two area units with only one neighbours.
:::
...
Interpretation: - The output reveals that Polygon ID=1 is Anxiang county.
