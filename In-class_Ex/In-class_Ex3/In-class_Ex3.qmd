...
Observations:
-   Within-zone (intrazone) distance = 0.
...
morning = push factor is origin 
evening = pull factor is destination bc ppl want to go home
...
Observations:
-   Distribution is highly skewed and not resemble bell shape or also known as normal distribution.
...
## Important
distance = -1.5 
definitely have to have -ve because it is inverse distance.
:::
...
ggarrange(unc_p, orc_p, dec_p, dbc_p,
          ...
          nrow = 2)
```
Looking at the plots, unconstrained a lot of dispersion.
double constrained is best
