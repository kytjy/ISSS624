...
-   Perform geocoding data downloaded from data.gov.sg
...
Next, convert the aspatial data into a simple feature tibble data called schools_sf.
...
Check the log variables, 1st col should always be positive to attract people. 
Distance must be -ve bc it is inverse relationship. ie people less willing to travel with longer dist = distance decay
p-values should be < 0.05 to accept as part of the conceptual models.
if > 0.05 = not statistically significant.
